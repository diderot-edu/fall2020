...
\begin{gram}[Step-by-Step Video Guide]
View the video below for a step-by-step guide:

\video{https://www.youtube.com/embed/klVWGHtRTuE}{Upload to YouTube}
\end{gram}
...
\video{https://www.youtube.com/embed/_j3pGmiKvxU}{How to change video privacy settings on YouTube}
\end{gram}
...
\begin{gram}[Where to adjust visibility settings]
    ...
    \video{https://www.youtube.com/embed/kuplp_Gd7xg}{Customize your upload preferences on YouTube}
\end{gram}
